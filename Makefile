...
.PHONY: all build run test smoke smoke-online regression protocol-observability r4-skill-regression r5-routing-regression package-release clean install fmt
